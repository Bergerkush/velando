          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
              ...
              <select
                ...
                style={{ padding: '9px 14px', border: '1.5px solid #e2e8f0', borderRadius: 9, fontSize: 13, color: '#334155', outline: 'none', background: '#fff', cursor: 'pointer' }}
              >
                ...
                {Array.from({ length: 12 }).map((_, i) => (
                  <div key={i} style={{ background: '#fff', borderRadius: 14, overflow: 'hidden', border: '1px solid #e2e8f0' }}>
                    ...
                    <div style={{ padding: 16 }}>
                      ...
                      <div style={{ height: 16, background: '#f1f5f9', borderRadius: 6, marginBottom: 16, width: '80%' }} />
                      <div style={{ height: 36, background: '#f1f5f9', borderRadius: 9 }} />
                    </div>
                  </div>
                ))}
              </div>
